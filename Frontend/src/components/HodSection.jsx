...
<style>{`
            ...
            `}</style>
            <h1 class="text-center text-gray-900 font-semibold text-3xl mt-7 sm:text-4xl md:text-5xl max-w-2xl leading-tight">
            Preferred choice of leaders in
            <span class="text-indigo-600">
                every industry
            </span>
        </h1>
        <p class="mt-4 text-center text-gray-600 mb-8 max-w-md text-sm sm:text-base leading-relaxed">
            Learn why professionals trust our solution to complete
            their customer journey.
        </p>
            <section className="flex flex-col md:flex-row px-3 mt-4 items-center justify-center gap-10 max-md:px-4">

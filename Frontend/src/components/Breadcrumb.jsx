...
export const Breadcrumb = () => {
  return (
        <div className="flex flex-wrap justify-center mt-16 items-center space-x-2 text-sm text-gray-500 font-medium">
            ...
            <Link to={"/departments/department-computer-science"} >Department of Computer Science</Link>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M6.784 15.68 11.46 4.13h1.75L8.534 15.68z" fill="#CBD5E1"/>
            </svg>
            <Link to={"/departments/department-arts-science"} >Department of Arts & Science</Link>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M6.784 15.68 11.46 4.13h1.75L8.534 15.68z" fill="#CBD5E1"/>
            </svg>
            <Link to={"/departments/department-commerce"}  className="text-indigo-500">Department of Commerce</Link>
        </div>
    );
}
